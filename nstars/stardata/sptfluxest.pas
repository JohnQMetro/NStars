...
const
  ...
  StarMagnitudes:array[1..7] of array[0..9] of Real = (
    ...
    (* K *) ( 5.76, 5.89, 6.19, 6.57, 7.04, 7.36, 7.8 , 8.15, 8.47, 8.69),
    (* M *) ( 8.91, 9.69,10.3 ,11.14,12.8 ,14.3 ,16.62,17.81,18.84,19.36)
  );
  MMagnitudes:array[0..19] of Real = (8.91,9.2,9.69,9.97,10.3,10.7,11.14,12.19,
  ...
  StarBmV:array[2..6] of array[0..9] of Currency = (
    ...
    (* K *) ( 0.816, 0.847, 0.884, 0.98,  1.1  , 1.15 ,  1.24, 1.308, 1.356, 1.382)
  );
  MBmV: array[0..18] of Currency = (1.408,1.441,1.475,1.486,1.5,1.522,1.544,
                    1.602,1.661,1.72,1.874,1.91,2,2.06,2.06,2.17,2.2,2.27,2.33);
  ...
  KsStarMagn:array[2..6] of array[0..9] of Currency = (
    ...
    (* K *) ( 3.81, 3.97, 4.04, 4.16, 4.31, 4.48, 4.66, 4.82, 4.98, 5.11)
  );
  ...
  JStarMagn:array[2..6] of array[0..9] of Currency = (
    ...
    (* K *) ( 4.29, 4.47, 4.57, 4.76, 4.98, 5.18, 5.41, 5.60, 5.78, 5.92)
  );
  ...
  RedDwarfVmIc:array[0..19] of Currency = (1.766,1.886,2.019,2.089,2.173,2.306,
      2.42,2.68,2.831,3.073,3.277,3.664,4.13,4.31,4.45,4.56,4.64,4.71,4.75,4.79);
  StarVmIc:array[2..6] of array[0..9] of Currency = (
    ...
    (* K *) ( 0.853, 0.879, 0.920, 1.013, 1.190, 1.272, 1.420, 1.529, 1.632, 1.699)
  );
  ...
  StarVmRc:array[3..6] of array[0..9] of Currency = (
    ...
    (* K *) (0.443,0.457,0.487,0.544,0.64 ,0.685,0.759,0.806 ,0.843,0.866)
  );
