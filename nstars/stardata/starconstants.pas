...
TempTable:array[1..6] of array[0..9] of Real = (
  ...
  (* K *) ( 5280, 5170, 5040, 4830, 4620, 4410, 4230, 4070, 4000, 3940)
);
...
BCorTable:array[1..6] of array[0..9] of Real = (
    ...
    (* K *) (-0.22,-0.26,-0.29,-0.41,-0.55,-0.68,-0.81,-0.950,-1.030,-1.10)
);
MBCorM:array[0..19] of Real = (-1.16,-1.38,-1.44,-1.57,-1.65,-1.76,-1.97,-2.27,
             -2.59,-3.05,-3.28,-3.8,-4.36,-4.6,-5.06,-5.46,-5.7,-5.8,-5.9,-6.13);
...
RedDwarfVmKs:array[0..19] of Currency = (3.68,3.84,4.02,4.12,4.24,4.43,4.6,5,
                          5.25,5.64,5.94,6.5,7.3,7.6,8.05,8.45,8.73,8.92,9,9.3);
StarVmKs:array[2..6] of array[0..9] of Currency = (
  ...
  (* K *) ( 1.953, 2.021, 2.132, 2.380, 2.733, 2.883, 3.143, 3.330, 3.487, 3.584)
);
VmKO95V:Currency = -0.977;

// V-J (used to produce test output)
KVmJ:array[0..9] of Real = (1.47,1.42,1.62,1.81,2.06,2.18,2.39,2.55,2.69,2.77);
MVmJ:array[0..19] of Real = (2.87,3.01,3.18,3.28,3.41,3.69,3.74,4.17,4.41,4.78,5.05,
                     5.58,6.34,6.60,7.05,7.38,7.61,7.69,7.83,7.97);
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
var
    altMSeq:Boolean;
