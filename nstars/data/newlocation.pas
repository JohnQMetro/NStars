...
EpochNames:array[0..7] of string = ('B1950','B1975','J2000','J2014','J2015','J2017','J2015.5','J1991.25');
...
begin
  ...
  else if xepoch = zJ1991q then startyear := 1991.25
...
begin
  Result := True;
  if (source = GAIA2_TAG) then Exit;
  if AnsiContainsStr(oldparallax,GAIA2_TAG) then Exit;
  Result := False;
end;
